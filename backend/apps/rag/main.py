...
from typing import List, Union, Sequence, Iterator, Any, Union, Sequence
...
from config import (
    ...
    RAG_OPENAI_API_KEY,
    DEVICE_TYPE,
    VECTOR_DATABASE_STORE,
    CHROMA_CLIENT,
    DATABASE_HOST,
    DATABASE_PORT,
    DATABASE_SECRET,
    VECTOR_DATABASE_METHOD,
...
def store_docs_in_vector_db(
    ...
    print(app.state.config.RAG_EMBEDDING_MODEL)
    ...
    if VECTOR_DATABASE_STORE == 'chroma':
        ...
        try:
            if overwrite:
                ...
                for collection_avail in CHROMA_CLIENT.list_collections():
                    if collection_name == collection_avail.name:
                        collection = collection_avail
                        break
        ...
        try:
            ...
            returned_ids = vectorDB.add_embeddings(
                texts = texts,
                embeddings = embeddings,
                metadatas = metadatas
            )
