...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    print("Database creation is happening")
...
def migrate_sqlite(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    class Document(pw.Model):
        id = pw.AutoField(unique = True)
        # dummy2 = pw.CharField()
        collection_name = pw.CharField(max_length=255, index = False, unique = False)
        # name = pw.TextField(index = False, unique = False)
        name = pw.CharField(max_length=255, index = False, unique = False)        
        title = pw.CharField()
    ...
    class Modelfile(pw.Model):
        id = pw.AutoField(unique = True)
        tag_name = pw.CharField(max_length=255, index = False, unique = False)
        user_id = pw.CharField(max_length=255, index = False, unique = False)
        ...
        class Meta:
            ...
            indexes = (
            (('tag_name', 'user_id'), True),
        )

    @migrator.create_model
    class Prompt(pw.Model):
        id = pw.AutoField(unique = True)
        command = pw.CharField(max_length=255, index = False, unique = False)
        user_id = pw.CharField(max_length=255, index = False, unique = False)
        title = pw.CharField()
